/*
    ...
    Refactor this code to use destructuring.  Can you get the body of the 'isEngineer' function down to a
    single line?
...
let isEngineer = ({title, department}) => title === 'Engineer' && department === 'Engineering';
